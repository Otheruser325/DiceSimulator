...
export function showAlert(scene, message, type = 'warning') {
  if (!scene) {
    console.warn('[AlertManager] showAlert called without a scene');
    return;
  }
  GlobalAlerts.show(scene, message, type);
}

function getTranslator() {
  if (typeof globalThis !== 'undefined' && globalThis.GlobalLocalization && typeof globalThis.GlobalLocalization.t === 'function') {
    return globalThis.GlobalLocalization.t.bind(globalThis.GlobalLocalization);
  }
